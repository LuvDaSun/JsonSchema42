...
impl SchemaTransform {
  ...
  pub const FLIP_ALL_OF_ANY_OF: Self = Self(33);
  pub const FLIP_ALL_OF_ONE_OF: Self = Self(34);
  pub const FLIP_ANY_OF_ALL_OF: Self = Self(35);
  pub const FLIP_ANY_OF_ONE_OF: Self = Self(36);
  pub const FLIP_ONE_OF_ALL_OF: Self = Self(37);
  pub const FLIP_ONE_OF_ANY_OF: Self = Self(38);
